...
<form class="form-horizontal" method="post" action="persyaratan_proses_tambah.php">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                  <div class="form-group">
                    <input type="text" id="nama_persyaratan" name="nama_persyaratan" class="form-control" required="" placeholder="Masukan Nama Persyaratan...">
                  </div>
                </div>
            </div>
