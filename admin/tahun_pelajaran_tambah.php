...
<form class="form-horizontal" method="post" action="tahun_pelajaran_proses_tambah.php">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                  <div class="form-group">
                    <input type="text" id="nama_tahun_pelajaran" name="nama_tahun_pelajaran" class="form-control" required="" placeholder="Masukan Nama Tahun Pelajaran...">
                  </div>
                </div>
            </div>
